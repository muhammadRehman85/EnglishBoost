...
const PresentIndefiniteIntro = () => {
  ...
  return (
    <ScrollView style={{padding:10}}>
      ...
      <ScrollView style={{marginTop:20}}><Text style={styles.Text}>The simple present tense is a grammatical tense in English used to describe actions, events, or states that are habitual, routine, general truths, or facts that are true in the present.
      </Text>
