...
import items from '../itemsData/PresentContinuesData/PresentConStructureItems'
import NestedList from '../../../stylingTemplates/NestedList'
import { ScrollView } from 'react-native-gesture-handler'
const PresentConDesc = () => {
  return (
    <ScrollView style={{paddingTop:20,paddingLeft:10}}>
      <Text style={{fontSize:18,fontWeight:'bold',color:'#004aad'}}>Structure of  Present Continues Tense</Text>
