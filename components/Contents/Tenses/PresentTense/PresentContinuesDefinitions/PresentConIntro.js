...
import items from "../itemsData/PresentContinuesData/PresentConItems";
    ...
    <ScrollView style={{ padding: 10 }}>
      ...
      <ScrollView style={{ marginTop: 20 }}>
        <Text style={styles.Text}>
          ...
          tense, is a verb tense in English that is used to describe actions or
          events that are happening at the current moment or are in progress at
          the time of speaking. It is formed by using the present tense of the
          verb "to be" (am, is, are) and adding the base form of the main verb
          with the -ing suffix.
        </Text>
